...
namespace KLine
{
    ...
    public class SearchDiv : MenuA
    {
        ...
        public void FilterSearch()
        {
            ...
            DataCenter.SecurityService.FilterSecurities(sText, securities);
            if (securities != null)
            {
        ...
        private void OnSelectRow()
        {
            ...
            if (rows != null && rows.Count > 0)
            {
                ...
                DataCenter.SecurityService.GetSecurityByCode(selectedRow.GetCell(0).Text, ref security);
                Visible = false;
                Invalidate();
                if (m_chart != null)
                {
                    if (m_categoryID != null && m_categoryID.Length > 0)
                    {
