/*********************************************************************************\
*                                                                                 *
* WinformControlHostEx.cs -Winform control host functions, types, and definitions.*
*                                                                                 *
*               Version 6.00                                                      *
*                                                                                 *
...
namespace piratecat
{
    ...
    /// 设计器管理
    /// </summary>
    public class WinformControlHostEx : WinformControlHost
    {
        ...
        public virtual void MouseEvent(String eventID, int dx, int dy, int data)
        {
